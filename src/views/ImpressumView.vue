<template>
  <div class="h-screen text-l text-left bg-gray-200 p-12">
    <div class="m-12">
      ...
      <h3 class="text-lg font-bold pt-4 pb-2">Google Analytics</h3>
      <p>
        ...
        Folgender Link führt Sie zu dem entsprechenden Plugin: <a
          href="https://tools.google.com/dlpage/gaoptout?hl=de">
        https://tools.google.com/dlpage/gaoptout?hl=de</a>
        Alternativ verhindern Sie mit einem Klick auf <a
          onclick="alert('Google Analytics wurde deaktiviert');"
          href="javascript:gaOptout()">diesen Link</a>, dass Google Analytics
      ...
      <h3 class="text-lg font-bold pt-4 pb-2">Rechte des Nutzers</h3>
      <p>
      ...
      <h3 class="text-lg font-bold pt-4 pb-2">Löschung von Daten</h3>
      <p>
      ...
      <h3 class="text-lg font-bold pt-4 pb-2">Widerspruchsrecht</h3>
      <p>
        ...
        Einwilligungen widerrufen möchten, wenden Sie sich bitte an folgende E-Mail-Adresse: thomaskaestner@protonmail.com
      </p>
    </div>
  </div>
</template>
